...
def solver(r,w):
    ...
    print("Gaussian Model Test set Score: {:.3f}".format(Gaussian_Model.score(x_test, y_test)))
    gc.collect()
    ...
    print("Neural Network Test set Score: {:.3f}".format(Neural_Model.score(x_test, y_test)))
    gc.collect()
    ...
    print("Logistic Model Test set Score: {:.3f}".format(Log_Model.score(x_test, y_test)))
    gc.collect()
    Dataset = read_train()
